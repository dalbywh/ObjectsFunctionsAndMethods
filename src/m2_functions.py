...
def turtle5():
    ...
    jake = rg.SimpleTurtle('triangle')
    fred.pen = rg.Pen ('purple',5)
    jake.pen = rg.Pen ('yellow',7)
    fred.draw_regular_polygon(5,30)
    jake.draw_regular_polygon(8, 100)
